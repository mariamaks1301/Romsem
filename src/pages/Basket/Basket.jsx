...
import { Testimage } from '../../assets/aboutMenu/corndog.png';
                    ...
                    <div className="basket__list">
                        <div className="basket__item">
                            <div className='basket__block-img'>
                                <img className='basket__item-img' src={'https://wasabi.kg/wp-content/uploads/2021/07/roll-losos.jpg'} alt="ComboImage" />
                            </div>
                            <div className='basket__item-info'>
                                <h3 className='basket__item-title'>ComboCombo ComboCombo</h3>
                                <p className="basket__item-price"> Цена за блюдо: 123 Сом</p>
                            </div>
                            <div className='basket__item-btns'>
                                <div className="basket__item-block">
                                    ...
                                    <p className="basket__item-price">10 </p>
                                    ...
                                    <p className="basket__item-price">123 Сом</p>
                                </div>
                                <div className='basket__item-block'>
                                    <button className='basket__item-btn basket__item-delete btn'>
